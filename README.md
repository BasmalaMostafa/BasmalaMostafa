## 👋 Hi, I'm Basmala Mostafa  

- 🔭 Currently working at **Ejada Company**  
- 💻 **ServiceNow Developer | Administrator**  
- 🚀 Skilled in building **custom components (CLI/UI), integrations, ITSM modules, and automation**  
- ⚡ Focused on **frontend development** (Angular & React) and **system integrations**  
- 🌱 Expanding my expertise in **IT Operations Management (ITOM)**, **cloud integrations**, and **advanced ServiceNow development**  
...
- **ServiceNow Platform**: Script Includes, Client Scripts, Business Rules, Scripted REST APIs, UI Builder, Flow Designer, ACLs  
- **Scripting & APIs**: JavaScript, Glide API  
...
<polygon transform="translate(-.3 -.5379)" points="109.7 6.6 113.1 6.6 115.9 14 118.7 6.6 121.6 6.6 124.3 14 127.1 6.6 130.6 6.6 125.5 19.5 122.9 19.5 120.1 12.2 117.4 19.5 114.8 19.5" fill="#293e40"/>
  ...
  <img width="12" />
  <img src="https://cdn.simpleicons.org/clickup/7B68EE" height="40" alt="clickup logo" />
  <img width="12" />
</div>  
